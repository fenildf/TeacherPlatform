...
function getPageName(filename){
	var data = {
		...
		'page.file.list.js'					:{title:'文件列表',url:'file_list.html'},
		...
		'page.project.chapter.create.js'	:{title:'创建讲',url:'project.chapter.create.html'},
		'page.project.chapter.list.js'		:{title:'浏览讲',url:'project.chapter.list.html'},
		'page.project.edit.js'				:{title:'编辑项目',url:'project.edit.html'},
		'page.project.list.js'				:{title:'项目列表',url:'project.list.html'},
		'page.project.outline.js'			:{title:'编辑大纲',url:'project.outline.html'},
